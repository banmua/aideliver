...
export const banner = {
    line: "<em style='font-weight:bold;color:red'>Next-day delivery of delicious Vietnamese Pho and Rolls!</em> Serving the cities Menlo Park, Palo Alto, Los Altos, Los Altos Hills, and Mountain View of California <span style='font-weight:bold;color:red'>Currently, available delivery times are: Mon-Fri 6:30pm, Sat-Sun 9am - 6:30pm.</span>",
}
